...
namespace PrimerKlk2
{
    ...
    partial void DeletePacijent(Pacijent instance);
		...
		public DomZdravljaDataContext() : 
				base(global::PrimerKlk2.Properties.Settings.Default.DomZdravljaConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnFirmaIDChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Paket_Pacijent", Storage="_Pacijents", ThisKey="PaketID", OtherKey="PaketID")]
	...
	public partial class Pacijent : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<double> _Popust;
    ...
    partial void OnPopustChanging(System.Nullable<double> value);
    ...
    partial void OnPaketIDChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Popust", DbType="Float")]
		public System.Nullable<double> Popust
		{
			get
			{
				return this._Popust;
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Paket_Pacijent", Storage="_Paket", ThisKey="PaketID", OtherKey="PaketID", IsForeignKey=true)]
		public Paket Paket
		{
			get
			{
